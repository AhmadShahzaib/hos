...
export default function GetEditLogHistory() {
  const getEditLogHistoryDecorator: Array<CombineDecoratorType> = [
  ...
  return CombineDecorators(getEditLogHistoryDecorator);
}
